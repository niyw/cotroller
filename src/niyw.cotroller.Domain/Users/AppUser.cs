...
namespace niyw.cotroller.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update cotrollerDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update cotrollerEfCoreEntityExtensionMappings to extend the IdentityUser entity
